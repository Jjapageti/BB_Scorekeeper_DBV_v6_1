...
let state=loadState();ScorekeeperCore.syncPlateAppearanceEvents(state);let undoStack=[],redoStack=[],activeCell=null,activeEventEditId=null,zoom=1,rbiManualTouched=false;
...
$$('[data-quick-result]').forEach(button=>button.addEventListener('click',()=>quickRecord(button.dataset.quickResult)));
